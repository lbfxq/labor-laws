                ...
                <div class="ibox-content">
                    <form id="form" method="post" class="form-horizontal" onsubmit="ajax_submit();return false;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input id="subject" type="text" placeholder="标题" name="postdata[subject]" class="form-control" required="" value="<?=$model->subject?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input id="send_from" type="text" placeholder="发送邮箱" name="postdata[send_from]" class="form-control" required="" value="<?=$model->send_from?>">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                         <div class="form-group">
                        ...
                        <div class="form-group"><label class="col-sm-2 control-label">状态</label>
                            <div class="col-sm-10">
                                <select class="form-control m-b" name="postdata[status]">
                                    ...
                                    <option value="0" <?php if ($model->status ==2){?> selected="selected"<?php }?> >禁用</option>
                                </select>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>

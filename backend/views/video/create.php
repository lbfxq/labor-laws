                ...
                <div class="ibox-content">
                    <form id="form" method="post" class="form-horizontal" onsubmit="ajax_submit();return false;" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input id="summary" type="text" placeholder="简介" name="postdata[summary]" class="form-control" required="" maxlength="40">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                               <textarea name="postdata[video_link]" id="video_link"  style="width:100%;height:200px;"></textarea>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea name="postdata[orator]" id="orator"  style="width:100%;height:300px;"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input id="vlen" type="text" placeholder="时长" name="postdata[vlen]" class="form-control" required="" maxlength="40">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>

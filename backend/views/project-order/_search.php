            ...
            <form role="form" class="form-inline" method="get">
                <div class="form-group">
                    ...
                    <input type="text" placeholder="订单号" id="search-uuid"
                           class="form-control" name="order_no" value="<?=$query['order_no']?>">
                </div>
                ...
                <div class="form-group">
                    <select class="form-control" name="status">
                        ...
                        <option value="2" <?php if($query['status']==2){?>selected="selected"<?php }?>>已支付</option>
                        <option value="3" <?php if($query['status']==3){?>selected="selected"<?php }?>>已取消</option>
                    </select>
                </div>
                <div class="form-group">

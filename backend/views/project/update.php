                ...
                <div class="ibox-content">
                    <form id="form" method="post" class="form-horizontal" onsubmit="ajax_submit();return false;" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input id="areas" type="text" placeholder="地区,多个地区用,隔开" name="postdata[areas]" class="form-control" required="" maxlength="40"  value="<?=$model->areas?>">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input id="pdate" type="text" placeholder="" name="postdata[pdate]" class="form-control" required="" value="<?=$model->pdate?>">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                               <textarea name="postdata[desc]" id="desc"  style="width:100%;height:200px;"><?=$model->desc?></textarea>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                        ...
                        <div class="form-group"><label class="col-sm-2 control-label">状态</label>
                            <div class="col-sm-10">
                                <select class="form-control m-b" name="postdata[status]">
                                    <option value="1" <?php if ($model->status ==1){?> selected="selected"<?php }?> >上线</option>
                                    <option value="2" <?php if ($model->status ==2){?> selected="selected"<?php }?> >下线</option>
                                </select>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>

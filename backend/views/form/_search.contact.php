...
<div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <form role="form" class="form-inline" method="get" id="searchform">
                ...
                <div class="form-group">
                    <label for="search-nickname" class="sr-only">用户名</label>
                    <input type="text" placeholder="用户名" id="search-nickname"
                           class="form-control" name="serach[username]" value="<?=$query['username']?>">
                </div>
                <div class="form-group">

                    ...
                    <form id="form" method="post" class="form-horizontal" onsubmit="ajax_submit();return false;">
                      ...
                      <!--   <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="keywords" type="text" placeholder="关键字,多个关键字用,隔开" name="postdata[keywords]" class="form-control" required="">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="des" type="text" placeholder="描述" name="postdata[des]" class="form-control" required="">
                            </div>
                        </div> -->
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="rank" type="text" placeholder="排序(填写数字，越大越靠前)" name="postdata[rank]" class="form-control" value="0" required="">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">

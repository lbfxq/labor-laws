                ...
                <div class="ibox-content">
                    <form id="form" method="post" class="form-horizontal" onsubmit="ajax_submit();return false"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input id="title" type="text" placeholder="标题" name="postdata[title]"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input id="public_date" type="text" placeholder="" name="postdata[public_date]"
                                       class="form-control date" required="" maxlength="40">
                            </div>
                        </div>
                       <!--  <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input id="summary" type="text" placeholder="简介" name="postdata[summary]"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="hidden" name="postdata[vimg]" id="vimg" value="">
                            </div>
                        </div> -->
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea name="postdata[content]" id="content"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input id="keywords" type="text" placeholder="关键字,多个关键字用,隔开" name="postdata[keywords]"
                                       class="form-control" required="">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input id="des" type="text" placeholder="描述" name="postdata[des]" class="form-control"
                                       required="">
                            </div>
                        </div> -->
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-2">
                                <button class="ladda-button ladda-button-demo btn btn-primary" type="submit"
                                        data-style="zoom-in" id="save">保 存
                                </button>
                            </div>
                        </div>
                    </form>
